    ...
    <div class="layout_container">
        ...
        <div class="layout_slider" :class="{fold:settingStore.fold? true:false }">
            ...
            <el-scrollbar class="scrollbar">
                <!-- 菜单组件 -->
                <el-menu :collapse="settingStore.fold? true:false" :default-active="$route.path" background-color="#001529" text-color="white" router>
                    <!-- 根据路由动态生成 -->
        ...
        <!-- 顶部导航 -->
        <div class="layout_tabber" :class="{fold:settingStore.fold? true:false }">
            <Tabber></Tabber>
        </div>
        <!-- 内容展示区域 -->
